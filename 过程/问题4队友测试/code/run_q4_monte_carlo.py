...
本地蒙特卡洛仿真测试脚本（支持 1,000 ~ 10,000 轮批量评测）
...
def main():
    ...
    parser.add_argument("--n", type=int, default=10000, help="仿真轮数 (默认 10000, 建议试跑可设 1000)")
    ...
    print("=" * 88, flush=True)
    print(f"★ 2026 国赛 B 题【问题4】N19 扇区优化模型 - 蒙特卡洛仿真评估", flush=True)
