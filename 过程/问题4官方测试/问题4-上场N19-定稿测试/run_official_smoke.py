#!/usr/bin/env python3
"""Attachment §11 four-command smoke. Use 问题4演练测试 only."""
...
from problem4_official_robot import OfficialClient, OfficialClosed, smoke_actions
...
def main() -> None:
    ...
    parser.add_argument(
        "--log",
        type=Path,
        default=Path("official_rehearsal") / "q4_smoke.jsonl",
    )
