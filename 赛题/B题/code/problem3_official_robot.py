"""Official HTTP robot. Decision code stays E15; this only talks to the simulator.

Does not start a test. The operator must log in and click 问题3演练测试 first.
Never click 问题3正式测试 from these scripts.
"""
...
from problem3_simulation_model import CHANNELS, Source
